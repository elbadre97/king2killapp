            ...
            <header className="text-center mb-8">
                <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6 rounded-2xl shadow-lg">
                    ...
                    <div className="flex justify-center items-center space-x-4 space-x-reverse">
                        <div className="bg-white/20 backdrop-blur-sm px-4 py-1 rounded-full text-sm font-semibold">💎 110</div>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-2xl p-4 shadow-lg mb-6 flex items-center">
                {user ? (
                    ...
                    <div className="text-center w-full">
                        ...
                        <div className="mt-6 p-3 bg-yellow-50 dark:bg-gray-800 border border-yellow-200 dark:border-gray-600 rounded-lg text-xs text-yellow-800 dark:text-yellow-300 text-right">
                            <p><strong>{t.accountAuthHelpNote}</strong></p>
                            <p className="mt-1">{t.accountAuthHelpDomain}</p>
                            <p className="font-mono text-center bg-white dark:bg-gray-700 p-2 rounded mt-2 select-all text-purple-600 dark:text-purple-400">{hostname}</p>
                        </div>
                    </div>
                )}
            </div>
