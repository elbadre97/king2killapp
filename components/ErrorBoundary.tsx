...
class ErrorBoundary extends Component<Props, State> {
  ...
  // This is a more traditional and robust way to initialize state in React class components,
  // resolving potential 'this' context issues in certain build setups.
